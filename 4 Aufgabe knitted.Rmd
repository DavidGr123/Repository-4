...
* **MO    =     Altria Group Rg (Philip Morris Companies)       (Sektor: BasiskonsumgÃ¼t,    Industrie: Tabak                                   )**
* **MDLZ  =     Mondelez International Inc.                     (Sektor: BasiskonsumgÃ¼t,    Industrie: Nahrungsmittel                          )**
* **PEP   =     PepsiCo Inc. (PEP)                              (Sektor: BasiskonsumgÃ¼t,    Industrie: GetrÃ¤nke                                )**
* **PM    =     Philip Morris International Inc.                (Sektor: BasiskonsumgÃ¼t,    Industrie: Tabak                                   )**
* **KHC   =     The Kraft Heinz Company                         (Sektor: BasiskonsumgÃ¼t,    Industrie: Nahrungsmittel                          )**
...
The objective to maximize mean return is a linear problem of the form: $maximize_w=ÂµË'\cdot w$
Where ÂµË is the estimated mean asset returns and w is the set of weights. Because this is a linear problem, it is well suited to be solved using a linear programming solver. For these types of problems, PortfolioAnalytics uses the ROI package with the glpk plugin.
...
Compute a multivariate location and scale estimate with a high breakdown point â this can be thought of as estimating the mean and covariance of the good part of the data. cov.mve and cov.mcd are compatibility wrappers.
...
Definition of Shrinkeage: Shrinkage is where extreme values in a sample are âshrunkâ towards a central value, like the sample mean.
