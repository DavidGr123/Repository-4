...
First, we get Data of our 10 Stocks. We use the same as in the previous exercise - all stocks are below are listed in the S&P500. 
We create a vector which contains all stocks we want to observe. 
Then, we get the stock prices from 2000-01-01 to 2018-08-31 and create monthly returns. 
```{r}
require(timetk)
